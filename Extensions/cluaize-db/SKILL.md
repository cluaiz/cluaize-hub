...
name: cluaize-db
version: 1.0.0
description: Core Database Engine for Cluaize
trigger: use plugin::database
---

# Skill: Cluaiz Database (cluaizd)

You are equipped with the Cluaize Core Database Engine. This allows you to persist data, manage users, and perform neural/vector searches.
